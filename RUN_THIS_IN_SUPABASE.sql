-- =====================================================
-- COMBINED SECURITY FIX MIGRATION
-- Run this entire script in Supabase SQL Editor
-- =====================================================

-- =====================================================
-- 1. Fix get_score_delta function
-- =====================================================
...
-- =====================================================
-- 2. Fix record_scorecard_change function
-- =====================================================
...
-- =====================================================
-- 3. Fix update_scorecard_timestamp function
-- =====================================================
...
-- =====================================================
-- 4. Fix is_team_owner helper function
-- =====================================================
...
-- =====================================================
-- 5. Fix check_email_uniqueness function
-- =====================================================
...
-- =====================================================
-- DONE! Now go to Security Advisor and click Refresh
-- =====================================================
